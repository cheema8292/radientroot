  ...
  renderContents(parsedState) {
    ...
    this.getSectionsToRender().forEach((section) => {
      ...
      if (section.id == "cart-drawer" || section.selector == "#CartDrawer") {
        ...
        if (newCartDrawer) {
          cartDrawerHandled = true;
          updateCartDrawer(sectionElement, newCartDrawer, true, openDrawer);
        }
      } else {
    ...
    // Fallback: if cart drawer element was missing, open immediately
    if (!cartDrawerHandled) {
      openDrawer();
    }
